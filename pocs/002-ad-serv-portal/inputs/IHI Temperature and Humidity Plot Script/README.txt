README
	...
	The "IHI_tempRHplotscript" script is used to batch plot IHI temperature and humidity data on individual graphs
	and with appropriate axes and labeling. By using the "matplotlib" Python library, plots can be saved, zoomed into, and generally analyzed.
...
HOW TO USE
	...
	2. Ensure the script is using the correct filenames/titles (i.e., f1, f2, etc, are equal to the files you want to plot) and header/index rows
	...
	4. Run the script using the following syntax:
		>> python [filepath]\IHI_tempRHplotscript.py   (generic example)
		>> python C:\Users\pgiessner\Documents\Scripts\IHI_tempRHplotscript.py   (specific user example)
